 ...
 */
 (function( w ) {
  ...
  var amznNs_CDPS = w.AmazonUIPageJS._namespace("CommonDetailPageScripts");

  amznNs_CDPS
    .when("jQuery", "A", "sh-utilities", "ready", "query-param")
    .execute(function($, a, shUtils, r, queryParam) {
    ...
    function filterList( searchInput ){
      ...
      if ( ! isEmpty( _CFG.filter.delimiters ) && typeof searchTxt === 'string' ){
